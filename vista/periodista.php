...
<body>
				...
				<ul class="navbar-nav mr-auto">
					<li class="nav-item active li-sign-in"><a class="nav-link"
						href="cerrar-sesion.php"> <img class="icon-position"
							...
							/ <?php echo $_SESSION["usuario"]["rol"] == 2 ? 'Periodista':'';?></span>
	...
	<div class="container-fluid latest-bg">
		...
		<div class="container latest-news">
			<div class="row">
				<div class="col-sm-6">
					<div class="custom-container">
						<a href="news-periodista.php?nid=<?php echo $noticias[0]['id']; ?>">
				...
				<div class="col-sm-3">
					<div class="custom-container">
						<a href="news-periodista.php?nid=<?php echo $noticias[1]['id']; ?>">
							<img class="img-fluid"
					...
					<div class="custom-container">
						<a href="news-periodista.php?nid=<?php echo $noticias[2]['id']; ?>">
				...
				<div class="col-sm-3">
					<div class="custom-container">
						<a href="news-periodista.php?nid=<?php echo $noticias[4]['id']; ?>">
					...
					<div class="custom-container">
						<a href="news-periodista.php?nid=<?php echo $noticias[3]['id']; ?>">
							<img class="latest-news-padding img-fluid"
	...
	<div class="container latest-news">
		<div class="row">
			<div class="col-3">
				<a href="news-periodista.php?nid=<?php echo $noticias[5]['id']; ?>">
			...
			<div class="col-3">
				<a href="news-periodista.php?nid=<?php echo $noticias[6]['id']; ?>">
			...
			<div class="col-3">
				<a href="news-periodista.php?nid=<?php echo $noticias[8]['id']; ?>">
			...
			<div class="col-3">
				<a href="news-periodista.php?nid=<?php echo $noticias[7]['id']; ?>">
	...
	<div class="container-fluid latest-news latest-bg">
		...
		<div class="container ">
			<div class="row">
				<div class="col-6">
				<a href="news-periodista.php?nid=<?php echo $noticias[9]['id']; ?>">
				...
				<div class="col-3">
				<a href="news-periodista.php?nid=<?php echo $noticias[10]['id']; ?>">
					<img class="img-fluid moda" height="200" src="img/pexels-photo-715821.jpeg" alt="">
				</a>
				<a href="news-periodista.php?nid=<?php echo $noticias[11]['id']; ?>">
